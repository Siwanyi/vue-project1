<template>
  <div class="pay">
    ...
    <div class="address">
      ...
      <div class="info" v-if="selectedAdress.address_id">
        <div class="info-content">
          <span class="name">{{ selectedAdress.name }}</span>
          <span class="mobile">{{ selectedAdress.phone }}</span>
        </div>
...
export default {
  ...
  computed: {
    ...
    handleLongAdress () {
      ...
      return region.province + region.city + region.region + this.selectedAdress.detail
    },
    // 获取路由查询参数
    mode () {
